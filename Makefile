...
ARDUINO_TEENSY_HOME = $(ARDUINO_TEENSY_PACKAGE)/hardware/avr/1.58.1
ARDUINO_TEENSY_TOOLS = $(ARDUINO_TEENSY_PACKAGE)/tools/teensy-tools/1.58.0
...
ARM_C_INCLUDES =  \
  ...
  -I$(ARDUINO_TEENSY_LIBRARIES)/ST7735_t3/src \
...
ST7735_t3_SOURCES = \
  $(ARDUINO_TEENSY_LIBRARIES)/ST7735_t3/src/glcdfont.c \
  $(ARDUINO_TEENSY_LIBRARIES)/ST7735_t3/src/st7735_t3_font_ComicSansMS.c \
  $(ARDUINO_TEENSY_LIBRARIES)/ST7735_t3/src/st7735_t3_font_Arial.c \
  $(ARDUINO_TEENSY_LIBRARIES)/ST7735_t3/src/ST7789_t3.cpp \
  $(ARDUINO_TEENSY_LIBRARIES)/ST7735_t3/src/ST7735_t3.cpp
